...
def upgrade() -> None:
    ...
    set_column_nullable("users", "clinic_id", nullable=True, existing_type=sa.String(length=36))
    ...
    create_index_if_missing("ix_inventory_items_clinic_id", "inventory_items", ["clinic_id"])
    create_index_if_missing("ix_inventory_items_sku", "inventory_items", ["sku"])
    ...
    create_index_if_missing("ix_lab_cases_clinic_id", "lab_cases", ["clinic_id"])
    create_index_if_missing("ix_lab_cases_patient_id", "lab_cases", ["patient_id"])
    create_index_if_missing("ix_lab_cases_dentist_id", "lab_cases", ["dentist_id"])
    create_index_if_missing("ix_lab_cases_status", "lab_cases", ["status"])
    ...
    create_index_if_missing("ix_imaging_studies_clinic_id", "imaging_studies", ["clinic_id"])
    create_index_if_missing("ix_imaging_studies_patient_id", "imaging_studies", ["patient_id"])
    create_index_if_missing("ix_imaging_studies_captured_by_id", "imaging_studies", ["captured_by_id"])
    create_index_if_missing("ix_imaging_studies_visit_id", "imaging_studies", ["visit_id"])
    ...
    create_index_if_missing("ix_drug_templates_clinic_id", "drug_templates", ["clinic_id"])
    ...
    create_index_if_missing("ix_prescriptions_clinic_id", "prescriptions", ["clinic_id"])
    create_index_if_missing("ix_prescriptions_patient_id", "prescriptions", ["patient_id"])
    create_index_if_missing("ix_prescriptions_prescribed_by_id", "prescriptions", ["prescribed_by_id"])
    create_index_if_missing("ix_prescriptions_status", "prescriptions", ["status"])
    ...
    create_index_if_missing("ix_prescription_items_prescription_id", "prescription_items", ["prescription_id"])
    ...
    create_index_if_missing("ix_staff_profiles_clinic_id", "staff_profiles", ["clinic_id"])
    create_index_if_missing("ix_staff_profiles_user_id", "staff_profiles", ["user_id"])
...
def downgrade() -> None:
    ...
    set_column_nullable("users", "clinic_id", nullable=False, existing_type=sa.String(length=36))
